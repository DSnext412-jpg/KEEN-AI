...
export const getGetUserProfileUrl = (params: GetUserProfileParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/user/profile?${stringifiedParams}` : `/api/user/profile`
}
...
export const getGetUserProfileQueryKey = (params?: GetUserProfileParams,) => {
    return [
    `/api/user/profile`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetUserProfileQueryOptions = <TData = Awaited<ReturnType<typeof getUserProfile>>, TError = ErrorType<GeminiError>>(params: GetUserProfileParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getUserProfile>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetUserProfileQueryError = ErrorType<GeminiError>
...
export function useGetUserProfile<TData = Awaited<ReturnType<typeof getUserProfile>>, TError = ErrorType<GeminiError>>(
...
export const getGetUserStatsUrl = (params: GetUserStatsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/user/stats?${stringifiedParams}` : `/api/user/stats`
}
