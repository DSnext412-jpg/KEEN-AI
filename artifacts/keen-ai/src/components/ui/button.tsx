...
const buttonVariants = {
  ...
  variants: {
    variant: {
      ...
      glow: "bg-primary text-primary-foreground shadow-[0_0_20px_rgba(139,92,246,0.5)] hover:shadow-[0_0_30px_rgba(139,92,246,0.8)] hover:bg-primary/90 transition-all duration-300",
    },
    size: {
